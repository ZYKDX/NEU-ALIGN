"""
    ...
    Filename: three_letter_months.py
   ...
   using their 3-letter abbreviation. Modify the code to be able to handle full
   month names as well as their numeric equivalent. For example, Feb, February
   and 2 would set days=28. Do this using logical operators.
"""
